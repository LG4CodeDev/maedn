...
app.use(express.json({limit: '6.9mb'}), cors());
...
/*
Check if a email is unique so user can be updated and created
 */
...
/*
Functions needed so player join the right game
 */
...
/*
Functions called to get a dice result and the fields reachable with this dice result
 */
...
/*
Functions so the move by a player is processed
 */
